...
class Article{
     ...
     *
     * @param object $conn Connection to the database
     * @param integer $limit Connection Number of records to retun
     * @param integer $offset Connection Number of records to skip
     *
     ...
     *
     * @return boolean True the current properties ara valid, fasle ortervise
     */
    protected function validate(){
        ...
        if ($this->published_at != '') {
            $date_time = date_create_from_format('Y-m-d', strval($this->published_at));
     ...
     * @param object $conn Connection to the database
     *
     * @return boolean True if the delete was successful, dalse otherwise
     */
    ...
    /**
     * Inster a new article with its current property values
     *
     * @param object $conn Connection to the database
     *
     * @return boolean True if the update was successful, false otherwise
